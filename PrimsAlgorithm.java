...
public class PrimsAlgorithm implements GraphAlgorithm {
    ...
    public String run(Map<Vertex, List<Edge>> graph, Vertex start) {
        ...
        if (graph.get(start).isEmpty()) {
            return "Prim : " + start.getId() + " (single vertex, no edges to connect)";
        }
        ...
        // and to match the "Prim: B=A, C=B, ..." format shown in the brief.
        return "Prim : " + processEdgesOfMST(edgesOfMST);
    }
